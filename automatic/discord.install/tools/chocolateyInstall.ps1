...
$packageArgs = @{
  ...
  fileType          = 'exe'
  url               = 'https://dl.discordapp.net/distro/app/stable/win/x86/1.0.9059/DiscordSetup.exe'
  url64bit          = 'https://stable.dl2.discordapp.net/distro/app/stable/win/x64/1.0.9164/DiscordSetup.exe'

  softwareName      = 'discord*'

  checksum          = '85060117d7c75378fcbf8b3824e79549002bc5298ae46fcaa2524c83c476596a'
  checksumType      = 'sha256'
  checksum64        = '4b0cb399b1deae7f9e07329de2c3ed60d4ba1a22b37ff371e9780babd343779c'
